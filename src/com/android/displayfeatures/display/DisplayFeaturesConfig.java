...
public class DisplayFeaturesConfig {
	...
	config_DisplayFeaturesDcDimPath = res.getString(com.android.settingslib.widget.R.string.config_DisplayFeaturesDcDimPath);
	config_DisplayFeaturesHbmPath = res.getString(com.android.settingslib.widget.R.string.config_DisplayFeaturesHbmPath);
	config_DisplayFeaturesFpsPath = res.getString(com.android.settingslib.widget.R.string.config_DisplayFeaturesFpsPath);
